        ...
        <div className="rules">
            ...
            <div className="content">
                <ul>
                    ...
                    <li>
                        Use the <b>value</b> (number) of the card to move your Sorcerer to the <b>right</b> (forward in time).
                    </li>
                    <li>
            ...
            <div className="content">
                <ul>
                    ...
                    <li>
                        If you have a matching set (called a Paradox), gain <b>1 point</b>, <b>advance the Codex color clockwise</b> to the next color,
            ...
            <div className="content">
                <ul>
                    ...
                    <li>
                       Players compare the cards in their hand, and the player with the highest total value wins.
                    </li>
                    <li>
